...
pub fn day3part1_example_test() {
  sample
  |> day3.sum_priorities()
  |> should.equal(157)
}

pub fn day3part1_data_test() {
  data
  |> day3.sum_priorities()
  |> should.equal(8105)
}

pub fn day3part2_example_test() {
  sample
  |> day3.sum_priorities2()
  |> should.equal(70)
}

pub fn day3part2_data_test() {
  data
  |> day3.sum_priorities2()
  |> should.equal(2363)
}
